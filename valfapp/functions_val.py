...
df_val = ag.run_query(r"C:\Users\kereviz\PycharmProjects\Charting\queries\valuation.sql")
...
df_val.to_excel(r"C:\Users\kereviz\PycharmProjects\Charting\outputs(xlsx)\val2022.xlsx")
del df_raw_material
