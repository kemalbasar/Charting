...
layout = return_adr_layout('preshane1',interval='week',position = '475px')

return_adr_timecallbacks('preshane1',interval='week',position = '475px')

return_adr_callbacks('preshane1',interval='week',position = '475px')
