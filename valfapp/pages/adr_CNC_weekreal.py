...
layout = return_adr_layout('cnc',interval='week',position = '45px')

return_adr_timecallbacks('cnc',interval='week',position = '45px')

return_adr_callbacks('cnc',interval='week',position = '45px')
