...
layout = return_adr_layout('cnc',interval='month',position = '45px')

return_adr_timecallbacks('cnc',interval='month',position = '45px')

return_adr_callbacks('cnc',interval='month',position = '45px')
