...
layout = return_adr_layout('cnctorna',interval='month',position = '45px')

return_adr_timecallbacks('cnctorna',interval='month',position = '45px')

return_adr_callbacks('cnctorna',interval='month',position = '45px')
