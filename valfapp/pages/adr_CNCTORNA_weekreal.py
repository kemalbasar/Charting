...
layout = return_adr_layout('cnctorna',interval='week',position = '45px')

return_adr_timecallbacks('cnctorna',interval='week',position = '45px')

return_adr_callbacks('cnctorna',interval='week',position = '45px')
