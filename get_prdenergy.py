...
start_date = datetime(begin_year, begin_month, 10)
end_date = datetime(final_year, final_month, 31)
...
for index, row in df.iterrows():
    ...
    if df_mpoint["MPOINT"][0] == 'valfsan_pano1_preshane1,valfsan_salter5,valfsan_salter2,valfsan_salter3':
