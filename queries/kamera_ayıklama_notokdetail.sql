WITH KMR_DATA AS (
    SELECT
        ...
        CASE
            ...
            WHEN A.ESMERKEZLILIK > M.ESMERKEZLILIK2 THEN 'EB'
            ELSE ''
        END AS NOTOKDETAIL,
        A.MATERIAL,
        A.CONFIRMATION
...
SELECT 	COUNT(CASE WHEN NOTOKDETAIL = 'IK' THEN 1 END) AS IK,
    ...
    COUNT(CASE WHEN NOTOKDETAIL = 'DB' THEN 1 END) AS DB,
    COUNT(CASE WHEN NOTOKDETAIL = 'EB' THEN 1 END) AS EB FROM KMR_DATA;
