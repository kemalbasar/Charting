SELECT
    B.WORKCENTER,B.MATERIAL,A.DRAWNUM,B.BLOCKQTY,B.PRODUCTBLOCKQTY,(B.BLOCKQTY - B.PRODUCTBLOCKQTY) AS REMAINPLN ,MAX(B.FINISHDAY)  AS FINISHDAY ,B.STEXT
	...
	WHERE B.CLOSED = 0
		...
		AND A.COMPANY = '01'
		AND A.CLIENT = '00'
		AND B.WORKCENTER NOT IN ('CNC-07', 'CNC-19', 'CNC-26', 'CNC-28', 'CNC-08', 'CNC-29')
	    AND B.WORKCENTER LIKE ('CNC-%')
